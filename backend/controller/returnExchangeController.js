...
router.post("/createReturnExchange", async(req, res) =>{
    try{
        ...
        const transactionId = await returnExchange.createReturnExchange(dateTransaction, transactionStatus, orderId, handledBy, approvedBy, 0);
        for(const transaction of transactions){
            ...
            await returnExchangeInfo.createReturnExchangeInfo(transaction.returnedProductId, transaction.returnedQuantity, exchangeProductId, exchangeQuantity, transaction.reason, transactionId, 0);
        }
